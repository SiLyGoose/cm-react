export default function PageNavigatorArrow(props) {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' width='11px' height='20px' viewBox='0 0 11 20' version='1.1' transform={props.transform}>
